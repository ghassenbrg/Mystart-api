    ...
    $(document).ready(function () {
        ...
        if (Morris.EventEmitter) {
            ...
            Morris.Area({
                ...
                lineColors: [ '#F78181', '#32D2C9'],
                xkey: 'period',
                ykeys: ['courses', 'services'],
                labels: ['courses', 'services'],
                pointSize: 0,
                lineWidth: 0,
                hideHover: 'auto'
            ...
            $('.chat-input').keypress(function (ev) {
                ...
                if (p == 13) {
                    if (chatText == "") {
                        ...
                        $('<li class="clearfix"><div class="chat-avatar"><img src="../img/chat-user-thumb.png" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>John Carry</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
                    }
                    $(this).val('');
